...
public class ListingHomeValuationComparablesCompsPropertyListingSubType {

    private Boolean is_forAuction;

    private Boolean is_bankOwned;

    private Boolean is_FSBO;

    private Boolean is_comingSoon;

    private Boolean is_newHome;
